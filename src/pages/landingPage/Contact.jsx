	...
	return (
		<section className="relative bg-white dark:bg-gray-900">
			<div className="stack py-8 lg:py-16 px-4 mx-auto max-w-screen-md z-20">
				...
				<form
					action="#"
					className="space-y-8 bg-purple-100 p-4 rounded-xl z-40"
				>
					<div>
						<label
							htmlFor="email"
					...
					<button
						type="submit"
						className="py-3 px-5 text-sm font-medium text-center text-white rounded-lg bg-purple-700 sm:w-fit hover:bg-purple-800"
					>
						Send message
					</button>
				</form>
